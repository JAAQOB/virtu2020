    ...
    <div id="home" class="tab-pane fade in active">
      <div class="row-outer">
		  ...
		  <select id="wpcr_structured_data_type"  name="wpcr_settings[wpcr_structured_data_type]">
			  <option value="none" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'none' ); ?>>None</option>
			  <option value="Product" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'Product' ); ?>>Product</option>
			  <option value="Book" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'Book' ); ?>>Book</option>
			  <option value="Course" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'Course' ); ?>>Course</option>
			  <option value="TVSeries" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'TVSeries' ); ?>>TVSeries</option>
			  <option value="CreativeWorkSeason" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'CreativeWorkSeason' ); ?>>CreativeWorkSeason</option>
			  <option value="CreativeWorkSeries" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'CreativeWorkSeries' ); ?>>CreativeWorkSeries</option>
			  <option value="Episode" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'Episode' ); ?>>Episode</option>
			  <option value="Game" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'Game' ); ?>>Game</option>
			  <option value="LocalBusiness" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'LocalBusiness' ); ?>>LocalBusiness</option>
			  <option value="MediaObject" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'MediaObject' ); ?>>MediaObject</option>
			  <option value="Movie" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'Movie' ); ?>>Movie</option>
			  <option value="MusicPlaylist" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'MusicPlaylist' ); ?>>MusicPlaylist</option>
			  <option value="MusicRecording" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'MusicRecording' ); ?>>MusicRecording</option>
			  <option value="Organization" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'Organization' ); ?>>Organization</option>
			  <option value="Recipe" <?php selected( $wpcr_options['wpcr_structured_data_type'], 'Recipe' ); ?>>Recipe</option>
			</select>
		  </div>
		  </div>
    ...
    <div id="menu1" class="tab-pane fade">
		<div class="row-outer">
		 ...
		 <div class="row-outer">
		  ...
		  <input type="radio" name="wpcr_settings[cmstr_pos]" value="1" <?php checked(1, $wpcr_options['cmstr_pos']); ?>  />
		  <span class="nav_label"><?php echo ( esc_html__('above', 'wp-post-comment-rating'));?></span>
		  </div>
		  <div class="nav_position">
		  <input type="radio" name="wpcr_settings[cmstr_pos]" value="0" <?php checked(0, $wpcr_options['cmstr_pos']); ?>  />
